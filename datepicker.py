...
class MyDatePicker(tk.Toplevel):
    ...
    def __init__(self, widget=None, format_str=None, entry=None):
        """
    ...
    def init_buttons(self):
        ...
        self.today = ttk.Button(self.frame1, text="Today", width=10,
                                    command=self.today_date)
        self.today.grid(row=1, columnspan=5, sticky=NSEW, padx=(100,0))
    ...
    def today_date(self):
        ...
        try:
            ...
            self.widget.insert(0, date_today)
        except AttributeError:
            pass
        self.entry.delete(0,'end')
        self.entry.insert(END, date_today)
        MyDatePicker.destroy(self)
    ...
    def get_date(self, clicked=None):
        ...
        month = str(self.month_names.index(self.month_str_var.get()))
        if len(month) == 1:
            month = "0" + month
        ...
        try:
            ...
            pass
        self.entry.delete(0,'end')
        self.entry.insert(END, self.full_date)
        MyDatePicker.destroy(self)
